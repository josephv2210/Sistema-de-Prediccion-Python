...
# year, area, record type, reliability, source year, value footnotes
...
# adecuar las variables categoricoas como pais, sexo, causa de muerte y edad
#la funcion permite ingresar la lista de los elementos categoricos y remplaza cada nombre por un numero
#la funcion necesita la columna, el dataset y flag que es para indicar si es una lista o una matriz
